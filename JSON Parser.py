...
import os
import pandas as pd
path_to_json = "C:\\Users\\harol\\Desktop\\TrashTasteProject\\OpenPose\\S1\\keypoints\\"
...
right_dataframe.to_csv(path_or_buf=r"C:\Users\harol\Desktop\TrashTasteProject\OpenPose\S1\left_dataframe.csv", index=True)
left_dataframe.to_csv(path_or_buf=r"C:\Users\harol\Desktop\TrashTasteProject\OpenPose\S1\right_dataframe.csv", index=True)
